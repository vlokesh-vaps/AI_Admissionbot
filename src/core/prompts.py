"""Prompt construction for natural, grounded admission assistance."""
...
def build_user_prompt(question: str, context: str, history: str = "") -> str:
    """Build a prompt that keeps retrieved facts separate from conversation context."""
    return f"""KNOWLEDGE-BASE CONTEXT (authoritative institution information):
{context or '[No relevant knowledge-base passage was retrieved.]'}
